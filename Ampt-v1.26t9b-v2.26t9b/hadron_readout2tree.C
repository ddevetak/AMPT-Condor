...
void hadron_readout2tree(){
   ...
   const string inputFileName = "/Users/damirdevetak/AMPT/Ampt-v1.26t9b-v2.26t9b/ana/ampt.dat";
   ifstream inputFile;
   ...
   while (inputFile>>nEvent){    // 1      1     7581            1.9717      181       189     2 179   2 187      0.0000
     //inputFile>>nEvent;        // nEvent tmp   nMultiplicity   b           nPartA    nPartB  tmp...............
     inputFile>>tmp;
     ...
     savedMultiplicity = 0;
     for(int i=0; i<nMultiplicity; i++){  // reading sub-block after pre-line defining the current Event
       inputFile>>pid; inputFile>>px;     // 2112    0.000    0.000    -99.9956  0.940    -5.76    -4.44    -0.20     0.20
       inputFile>>py; inputFile>>pz;      // pid     px       py       pz        m        x        y        z         t
